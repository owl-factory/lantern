...
import { MapController, MapSizeUnit } from "./MapController";

/**
 * Fetches the map's current height in pixels
 */
export function getMapHeight(this: MapController): number { return this.mapSize.height; }

/**
 * Fetches the map's current width in pixels
 */
export function getMapWidth(this: MapController): number { return this.mapSize.width; }
/**
 * Fetches the number of tiles (hexes, squares, pixels) this map is tall
 */
export function getMapUnitHeight(this: MapController): number { return this.mapSize.height; }
/**
 * Fetches the number of tiles (hexes, squares, pixels) this map is wide
 */
export function getMapUnitWidth(this: MapController): number { return this.mapSize.width; }
/**
 * Fetches the tile type currently being used
 */
export function getMapUnit(this: MapController): MapSizeUnit { return this.mapSize.unit; }

/**
 * Sets the new height of the map in pixels
 * @param height The new height of the map, in pixels
 */
export function setMapHeight(this: MapController, height: number): void {
 ...
 */
export function setMapWidth(this: MapController, width: number): void {
 ...
 */
export function setMapUnitHeight(this: MapController, unitHeight: number): void {
 ...
 */
export function setMapUnitWidth(this: MapController, unitWidth: number): void {
 ...
 */
export function setMapUnit(this: MapController, unit: MapSizeUnit): void {
 ...
 */
export function setDefaultMap(this: MapController): void {
 ...
 */
export function pixelsToUnit(this: MapController, pixels: number): number {
 ...
 */
export function unitToPixels(this: MapController, units: number): number {
  switch(this.mapSize.unit) {
    case MapSizeUnit.Squares:
 ...
 */
export function pixelsToNearestUnit(this: MapController, pixels: number): number {
