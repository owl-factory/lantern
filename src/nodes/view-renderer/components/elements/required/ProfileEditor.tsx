import { ProfileEditorAttributes } from "nodes/view-renderer/types/attributes";
import { RenderProps } from "nodes/view-renderer/types/renderProps";
import React from "react";

/**
 * Renders the ProfileEditor element for use within a View
 ...
 */
 export function ViewProfileEditor(props: RenderProps<ProfileEditorAttributes>) {
  return (
    <>Profile</>
  );
}
