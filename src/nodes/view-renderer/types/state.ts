...
export interface RenderState {
  collapses: Record<string, boolean>; // An object of the collapse elements and whether they are open or closed
  pages: Record<string, string>; // An object of pageGroup IDs and their active page name
}
