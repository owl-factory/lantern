...
import { ButtonAction } from "nodes/view-renderer/enums";
import { ViewState } from "nodes/view-renderer/types";
import { ButtonDescriptor } from "../../../types/elements/utility/button";
 ...
 */
export function parseButtonElement(element: Element, state: ViewState) {
