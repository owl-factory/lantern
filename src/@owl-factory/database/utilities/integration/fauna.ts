import { fromFauna, fromIndex } from "@owl-factory/database/utilities/conversion/fauna/from";
import { toFauna, toRef } from "@owl-factory/database/utilities/conversion/fauna/to";
