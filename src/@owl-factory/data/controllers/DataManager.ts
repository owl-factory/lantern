...
import { BatchingController } from "./BatchingController";
import { getUpdatedAt, isValidRef } from "../utilities/fields";
import { CrudPacket } from "@owl-factory/types/object";
import { getUniques } from "@owl-factory/utilities/arrays";
import { getSuccessfulDocuments } from "../utilities/data";
import { Cacheable } from "@owl-factory/cache";
...
export class DataManager<T extends Record<string, unknown>> {
   ...
   */
  public async load(targetRefs: Ref64[] | Ref64 | null | undefined, reloadPolicy?: ReloadPolicy): Promise<void> {
    if (targetRefs === null || targetRefs === undefined) { return; }
