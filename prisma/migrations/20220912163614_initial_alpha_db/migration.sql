...
-- CreateIndex
CREATE UNIQUE INDEX "SceneFile_sceneID_key" ON "SceneFile"("sceneID");

-- CreateIndex
CREATE UNIQUE INDEX "SceneFile_fileID_key" ON "SceneFile"("fileID");
...
-- AddForeignKey
ALTER TABLE "File" ADD CONSTRAINT "File_ownedBy_fkey" FOREIGN KEY ("ownedBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SceneFile" ADD CONSTRAINT "SceneFile_sceneID_fkey" FOREIGN KEY ("sceneID") REFERENCES "Scene"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SceneFile" ADD CONSTRAINT "SceneFile_fileID_fkey" FOREIGN KEY ("fileID") REFERENCES "File"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
